        ...
        <div className="fixed inset-0 z-[9998] flex items-center justify-center p-4 animate-fade-in" role="dialog" aria-modal="true" aria-label="Keyboard shortcuts">
            ...
            <div className="relative glass-card-heavy border-white/10 shadow-2xl rounded-2xl p-6 max-w-md w-full animate-scale-in">
                <div className="flex items-center justify-between mb-6">
                    ...
                    <button onClick={onClose} className="p-2 rounded-xl text-slate-500 hover:text-[var(--text-main)] hover:bg-white/10 transition-all">
                        <X className="w-4 h-4" />
                    </button>
                </div>
                                        ...
                                        <div className="flex items-center gap-1">
                                            {item.keys.map((key, j) => (
                                                <React.Fragment key={j}>
                                                    <kbd className="min-w-[28px] h-7 flex items-center justify-center px-2 bg-white/5 border border-white/10 rounded-lg text-[11px] font-bold text-[var(--text-dim)]">
                                                        {key}
                                                    </kbd>
