...
function citationColor(count = 0) {
    ...
    if (count >= 10)  return 'text-sky-400 border-sky-400/30 bg-sky-400/5';
    ...
    return (
        <div
            ...
            className={`
                ...
                ${isSeed
                    ? 'bg-sky-500/10 border-sky-500/40 shadow-lg shadow-sky-500/20 scale-105 ring-2 ring-sky-500/20'
                    : isActive
                        ? 'bg-white/10 border-sky-400/50 shadow-md'
                        : 'bg-white/[0.03] border-white/10 hover:border-sky-400/30 hover:bg-white/[0.06]'
                }
            `}
        >
            {isSeed && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-full bg-sky-500 text-white text-[9px] font-black uppercase tracking-widest shadow">
                    Seed Paper
                </div>
            )}
                        ...
                        <>
                            ...
                            <div className="flex flex-wrap items-center gap-6 mb-8 pb-6 border-b border-white/5">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-xs font-black uppercase tracking-widest text-sky-400">References</span>
                                    <span className="px-2 py-0.5 rounded-full bg-sky-500/10 border border-sky-500/20 text-sky-300 text-xs font-black">
                            ...
                            <div className="flex items-center gap-6 mb-6 text-[10px] font-black uppercase tracking-widest text-slate-500">
                                <span className="flex items-center gap-1.5">
                                    <span className="w-8 h-0.5 bg-sky-500/60 inline-block" />
                            ...
                            >
                                ...
                                >
                                    {lines.map((line, i) => (
                                        <path
                                            ...
                                            d={line.d}
                                            fill="none"
                                            stroke={line.type === 'ref' ? 'rgba(14, 165, 233,0.35)' : 'rgba(52,211,153,0.35)'}
                                            strokeWidth="1.5"
                                ...
                                <div className="space-y-3 relative z-10">
                                    <p className="text-[10px] font-black uppercase tracking-widest text-sky-400 mb-4 flex items-center gap-2">
                                        ...
                                        <div className="flex flex-col gap-2 shrink-0">
                                            {onSearch && (
                                                <button
                                                    ...
                                                    className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-sky-500/10 text-sky-400 border border-sky-500/20 hover:bg-sky-500/20 text-xs font-black uppercase tracking-widest transition-all"
                                                >
