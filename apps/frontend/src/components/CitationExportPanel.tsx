            ...
            >
                <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                        <p className="text-sm font-black text-[var(--text-main)] uppercase tracking-widest">Export Citations</p>
                ...
                {isOpen
                    ? <ChevronUp className="w-4 h-4 text-slate-500 group-hover:text-sky-400 transition-colors" />
                    : <ChevronDown className="w-4 h-4 text-slate-500 group-hover:text-sky-400 transition-colors" />
                }
            </button>
            ...
            {isOpen && (
                <div className="px-6 pb-6 space-y-4 animate-slide-up">
                            ...
                            <button
                                ...
                                className={`px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest border transition-all duration-300 ${
                                    activeFormat === fmt.id
                                        ...
                                        : 'bg-white/[0.02] text-slate-500 border-white/5 hover:text-[var(--text-main)] hover:border-white/15'
                                }`}
                            >
                                {fmt.label}
                            </button>
                    ...
                    <div className="relative">
                        <pre className="w-full max-h-64 overflow-y-auto custom-scrollbar bg-black/30 border border-white/10 rounded-2xl p-5 text-xs text-[var(--text-dim)] font-mono leading-relaxed whitespace-pre-wrap">
                            {citationText}
                        </pre>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className={`flex items-center gap-2 px-5 py-3 rounded-xl border text-xs font-black uppercase tracking-widest transition-all duration-300 ${
                                copied
                                    ...
                                    : 'bg-white/5 text-slate-400 border-white/10 hover:text-[var(--text-main)] hover:border-white/20'
                            }`}
                        >
                            {copied
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-5 py-3 rounded-xl border bg-sky-500/10 text-sky-400 border-sky-500/20 hover:bg-sky-500/20 text-xs font-black uppercase tracking-widest transition-all"
                        >
