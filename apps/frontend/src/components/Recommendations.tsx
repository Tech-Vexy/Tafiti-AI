...
export const Recommendations = ({ topics, onSelect, isLoading }: { topics: { title: string; description: string }[] | null; onSelect: (title: string) => void; isLoading: boolean }) => {
    if (isLoading) {
        return (
...
export const PreferenceForm = ({ onSave, isLoading, user }: { onSave: (prefs: { career_field: string; interests: string[] }) => void | Promise<void>; isLoading: boolean; user?: (User & { bio?: string }) | null }) => {
            ...
            <div className="space-y-6">
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-4 focus:ring-2 focus:ring-sky-500/50 outline-none transition-all"
                        required
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <textarea
                        ...
                        rows={3}
                        className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-4 focus:ring-2 focus:ring-sky-500/50 outline-none transition-all resize-none"
                        required
                    />
