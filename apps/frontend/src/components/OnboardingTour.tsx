...
const TOUR_STEPS = [
    ...
    },
    {
        ...
        placement: 'right',
        accent: 'from-sky-500 to-pink-400',
    },
    {
        id: 'command-palette',
    ...
    return (
        <div
            ...
            style={{
                ...
                borderRadius,
                boxShadow: `0 0 0 9999px rgba(0, 0, 0, 0.7), 0 0 40px rgba(14, 165, 233, 0.3), inset 0 0 20px rgba(14, 165, 233, 0.1)`,
            }}
        />
    );
};
                ...
                <div className="p-6 space-y-5">
                    ...
                    <div className="flex items-start justify-between gap-3">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h3 className="text-base font-black text-[var(--text-main)] tracking-tight">{step.title}</h3>
                        ...
                        <button
                            onClick={onSkip}
                            className="p-1.5 rounded-lg text-slate-600 hover:text-[var(--text-main)] hover:bg-white/10 transition-all shrink-0"
                            title="Skip tour"
                        >
                            <X className="w-4 h-4" />
                        </button>
                    ...
                    <div className="flex items-center justify-between gap-3">
                        {!isFirst ? (
                            <button
                                onClick={onPrev}
                                className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold text-slate-500 hover:text-[var(--text-main)] hover:bg-white/5 border border-white/5 transition-all"
                            >
                        ...
                        {isLast ? (
                            <button
                                onClick={onFinish}
                                className="flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold dark:bg-[#FDFBFA] dark:text-[#171616] bg-[#3A3D45] text-[#FDFBFA] hover:opacity-90 transition-all"
                            >
            ...
            <div className={`transition-all duration-700 ease-out ${isReady ? 'opacity-100 scale-100' : 'opacity-0 scale-90'}`}>
                <div className="glass-card-heavy border-white/10 shadow-2xl rounded-3xl p-8 sm:p-12 max-w-lg w-full text-center space-y-8">
                    ...
                    <div className="relative mx-auto w-20 h-20">
                        <div className="relative w-full h-full dark:bg-[#1E1D1C] bg-slate-100 rounded-2xl flex items-center justify-center border dark:border-[#383B43] border-[#8A8884]/30">
                            <Rocket className="w-10 h-10 text-slate-300" />
                        </div>
                    </div>

                    <div className="space-y-3">
                        <h1 className="text-3xl font-bold tracking-tight dark:text-[#FDFBFA] text-[#3A3D45]">
                            Welcome to Tafiti
                        </h1>
                    ...
                    <div className="flex flex-wrap justify-center gap-2">
                        {[
                            { icon: Search, label: 'Search', color: 'sky' },
                            ...
                            { icon: PenLine, label: 'Thesis', color: 'sky' },
                        ].map(f => (
                    ...
                    <div className="flex items-center justify-center gap-3 pt-2">
                        <button
                            onClick={onSkip}
                            className="px-5 py-2.5 rounded-xl text-sm font-bold text-slate-500 hover:text-[var(--text-main)] hover:bg-white/5 transition-all"
                        >
                            Skip Tour
                        </button>
                        <button
                            onClick={onNext}
                            className="flex items-center gap-2 px-8 py-3 rounded-xl text-sm font-bold dark:bg-[#FDFBFA] dark:text-[#171616] bg-[#3A3D45] text-[#FDFBFA] hover:opacity-90 active:scale-[0.98] transition-all"
                        >
                            Take the Tour
